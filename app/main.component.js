    ...
    render: function(){
        ...
        switch(this.state.currentMode){
            case 'read':
                break;
            case 'readOne':
                modeComponent = <TrackProductComponent productId={this.state.productId} changeAppMode={this.changeAppMode}/>;
                break;
            case 'create':
            ...
            case 'delete':
                ...
                break;
            case 'addTracking':
                modeComponent = <AddTrackingComponent productId={this.state.productId} changeAppMode={this.changeAppMode}/>;
                break;
            default:
                break;
        }
